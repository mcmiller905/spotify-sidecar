...
var config = require('./config'); // keep id and secret in a separate gitignored file
...
app.get('/login', function(req, res) {
  ...
  var scope = 'user-read-private user-read-email user-read-currently-playing user-read-recently-played user-read-playback-state user-modify-playback-state playlist-modify-public';
